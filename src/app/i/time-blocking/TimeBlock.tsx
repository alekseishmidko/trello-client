...
import { useDeleteTimeBlock } from './hooks/useDeleteTimeBlocks'
import { useTimeBlockSortable } from './hooks/useTimeBlocksSortable'

export function TimeBlock({ item }: { item: ITimeBlockResponce }) {
